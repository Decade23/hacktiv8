<aside class="sidenav-main nav-expanded nav-lock nav-collapsible sidenav-light sidenav-active-square">
  <div class="brand-sidebar">
    <h1 class="logo-wrapper"><a class="{{-- brand-logo darken-1 --}}" href="#"><img src="{{ asset('image/logo.png') }}" style="width: 25%" alt="kepegawaian logo"/><span class="logo-text hide-on-med-and-down">MAN 1</span></a><a class="navbar-toggler" href="#">{{-- <i class="material-icons">radio_button_checked</i> --}}</a></h1>
  </div>
    ...
    <li class="bold"><a class="collapsible-header waves-effect waves-cyan " href="#"><i class="material-icons">settings_input_svideo</i><span class="menu-title" data-i18n="">Dashboard</span><span class="badge badge pill orange float-right mr-10">3</span></a>
      <div class="collapsible-body">
        <ul class="collapsible collapsible-sub" data-collapsible="accordion">
          <li><a class="collapsible-body" href="{{ route('dashboard.pegawai.index') }}" data-i18n=""><i class="material-icons">radio_button_unchecked</i><span>Data Pegawai</span></a>
          </li>
          <li><a class="collapsible-body" href="{{ route('dashboard.pegawai.index') }}" data-i18n=""><i class="material-icons">radio_button_unchecked</i><span>Riwayat Pendidikan</span></a>
          </li>
