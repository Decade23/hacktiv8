<header class="page-topbar" id="header">
      <div class="navbar navbar-fixed"> 
        ...
        <nav class="navbar-main navbar-color nav-collapsible sideNav-lock no-shadow navbar-dark purple"> 
...
{{--              <li><a class="waves-effect waves-block waves-light profile-button" href="javascript:void(0);" data-target="profile-dropdown"><span class="avatar-status avatar-online"><img src="{{asset('/image/avatar.png')}}" alt="avatar"><i></i></span></a></li>--}}
